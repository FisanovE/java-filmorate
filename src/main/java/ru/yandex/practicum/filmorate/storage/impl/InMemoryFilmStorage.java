...
public class InMemoryFilmStorage implements FilmStorage {
    ...
    private final Map<Long, Genre> genres = Map.of(1L, Genre.builder().id(1L).name("Комедия")
            .build(), 2L, Genre.builder().id(2L).name("Драма")
            .build(), 3L, Genre.builder().id(3L)
            .name("Мультфильм")
            .build(), 4L, Genre.builder()
            .id(4L)
            .name("Триллер")
            .build(), 5L, Genre.builder()
            .id(5L)
            .name("Документальный")
            .build(), 6L, Genre.builder()
            .id(6L)
            .name("Боевик")
            .build());

    private final Map<Long, Mpa> ratingsMpa = Map.of(1L, Mpa.builder().id(1L).name("G").build(), 2L, Mpa.builder()
            .id(2L)
            .name("PG")
            .build(), 3L, Mpa.builder()
            .id(3L)
            .name("PG-13")
            .build(), 4L, Mpa.builder()
            .id(4L)
            .name("R")
            .build(), 5L, Mpa.builder()
            .id(5L)
            .name("NC-17")
            .build());
